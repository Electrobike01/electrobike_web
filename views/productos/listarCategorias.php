...
if (isset($_POST)) {
    $categoriaBicicleta = $_GET['categoria'];
    $nombreCat = '';
...
<body class="animate-in-ov">
    ...
    <section class="home">
        ...
        <div class="container">
            ...
            <h3 id="categoria_lista"><?php echo $nombreCat ?></h3>

            <div class="elementos">
                <a href="../productos/registrar.php"><button class="Btn btn btn-primary">Registrar</button></a>
