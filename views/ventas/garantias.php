...
<body class="animate-in-ov">
    ...
    <section class="home">
        ...
        <div class="container">
            ...
            <div class="elementos">
                <a href="../ventas/registrar.php"><button class="Btn btn btn-primary">Registrar</button></a>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th class="text-center">ID Garantia</th>
        ...
        <h1 class="page" id="SubModuloActual">garantias</h1>
    </section>
